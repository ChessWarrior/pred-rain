...
if __name__ == '__main__':
	...
	parser.add_argument('--records', type=str, help='the path to the output .tfrecords file (postfix is appended automatically).')
	parser.add_argument('--data_dir', type=str, help='the parent directory that contains the the sequence folders.')
	args = parser.parse_args()
	file_name = args.records + '.tfrecords'
	assert Path(args.data_dir).isdir()
	
	cvt = cvter(file_name=file_name, data_dir=args.data_dir)
