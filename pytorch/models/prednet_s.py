...
class PredNetS(nn.Module):
    def __init__(self, R_channels, A_channels, output_mode='error'):
        ...
        # some processing before making predictions based on the errors of a lower layer
...
def prednet_s(): 
    ...
    return PredNetS(A_channels, R_channels, output_mode='error')
